--- The p6m platform standards, held against the dotnet BASIC service archetype.
---
...
--- network. Docker is the single requirement — no .NET SDK on the host, so this suite behaves
